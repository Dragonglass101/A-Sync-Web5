    ...
    return (
        <div className="container my-5">
            ...
            <div className="d-flex flex-column justify-content-start w-25">
                <Button variant="outlined" style={{textTransform:'capitalize', fontFamily:'Space Mono'}} className="my-3" onClick={handleReadWorkout}> Get All Workouts from user</Button>
                <Button variant="outlined" style={{textTransform:'capitalize', fontFamily:'Space Mono'}} className="my-3" onClick={handleExercise}> Get All Exercises user without parent</Button>
                <Button variant="outlined" style={{textTransform:'capitalize', fontFamily:'Space Mono'}} className="my-3" onClick={handleWriteRec}> Write Rec Exercises</Button>
            </div>
        </div>
    );
};
