...
const FitbitServer = () => {
    ...
    async function handleReadWorkout(){
        ...
        const workoutRecords1 = await fitbitService.queryWorkoutRecords(did);
        const exerciseRecords = await fitbitService.queryExerciseRecords(workoutRecords[0].id, userDid);
        const exerciseRecords1 = await fitbitService.queryExerciseRecords(workoutRecords1[0].id, did);
