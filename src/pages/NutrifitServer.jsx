...
const NutrifitServer = () => {
    ...
    return (
        <div>
        <h1>Nutrifit Server</h1>
        <p>{did}</p>
        <button onClick={handleReadMeals}> Get All Meals from user</button>
        <div>
        <button onClick={handleFood}> Get All Foods user without parent</button>
        </div>
        <div>
        <button onClick={handleWriteRec}> Write Rec Foods</button>
        </div>
        </div>
    );
};
