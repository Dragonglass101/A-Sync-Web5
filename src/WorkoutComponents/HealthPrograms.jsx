...
const HealthPrograms = () => {
  ...
  const exerciseCards = [];
  const temp = healthyFoodsList.slice(0, 4);
  for (let exe of temp) {
    exerciseCards.push(
      <article onClick={(e) => { handleSelectExercise(e, exe) }} className="selectedHealthcard programstoprogram d-flex flex-column align-items-center p-0" style={{ borderRadius: '25px', width: '250px' }} >
